...
// at the top of a `// @ts-check`-enabled file to get IDE hints. Runtime
// consumers normalize provider output through the shared job-record contract,
// while provider fixtures verify each adapter without contacting real sites.
 ...
 *
 * Provider-specific fields are opaque to the shared contract and validated by the
...
/**
 * What the discovery runner hands to provider.fetch(). Only `transport: 'http'`
